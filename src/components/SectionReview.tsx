  ...
  return (
    <div className="bg-white border border-gray-200 rounded-sm shadow-xs overflow-hidden">
      ...
      <div className="p-6 sm:p-8 space-y-6">
        <div className="p-4 bg-emerald-50 border-l-4 border-emerald-600 text-xs text-emerald-900 rounded-r-sm flex items-start gap-3">
          <CheckCircle2 className="w-5 h-5 text-emerald-600 shrink-0 mt-0.5" />
          <div>
            <span className="font-bold block text-sm">Please verify all nomination information</span>
        ...
        <div className="space-y-4">
          ...
          <div className="border border-gray-200 rounded-sm bg-white overflow-hidden">
            <div className="bg-[#f8fafc] px-4 py-2.5 border-b border-gray-200 flex justify-between items-center">
              ...
              <button
                ...
                className="text-xs text-[#0b3c68] hover:text-[#082a4a] hover:bg-gray-100 px-2.5 py-1 rounded font-bold uppercase tracking-wider transition-colors flex items-center gap-1 border border-gray-200"
              >
            ...
            <div className="p-4 grid grid-cols-1 sm:grid-cols-2 gap-3 text-xs">
              ...
              <div>
                ...
                <span className="font-medium text-gray-800">{formData.authEmail}</span>
              </div>
              <div>
          ...
          <div className="border border-gray-200 rounded-sm bg-white overflow-hidden">
            <div className="bg-[#f8fafc] px-4 py-2.5 border-b border-gray-200 flex justify-between items-center">
              <span className="text-xs font-bold text-[#0b3c68] uppercase tracking-wider flex items-center gap-1.5">
                ...
                03. Nominee Roster ({formData.nominees.length} Participant{formData.nominees.length > 1 ? 's' : ''})
              </span>
              <button
                type="button"
            ...
            <div className="p-4 divide-y divide-gray-100">
              {formData.nominees.map((nom, i) => (
                <div key={nom.id || i} className="py-2.5 first:pt-0 last:pb-0 flex flex-col sm:flex-row sm:items-center justify-between gap-2 text-xs">
                  <div>
                  ...
                  <div className="text-gray-600 font-mono text-[11px] flex items-center gap-3">
                    <span>{nom.email}</span>
                    <span>•</span>
          ...
          <div className="border border-[#0b3c68]/30 rounded-sm bg-[#fafcff] overflow-hidden">
            <div className="bg-[#0b3c68] text-white px-4 py-2.5 flex justify-between items-center">
              ...
              <button
                ...
                className="text-xs text-white hover:bg-white/20 px-2.5 py-1 rounded font-bold uppercase tracking-wider transition-colors flex items-center gap-1 border border-white/20"
              >
                <Edit2 className="w-3 h-3" />
                Edit
              </button>
          ...
          >
            ...
            <span>
              {isSubmitting
                ? 'Processing...'
                : formData.paymentPreference === 'pay_now'
                ? 'Submit & Pay Now (Gateway)'
                : 'Submit Nomination (Pay Later)'}
            </span>
          </button>
        </div>
      </div>
